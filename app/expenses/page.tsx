...
import { Minus, Trash2, Edit2, Loader2 } from 'lucide-react';
        ...
        <main className="flex-1 lg:ml-72 pt-16 lg:pt-0 p-8 flex items-center justify-center">
          <div className="text-center">
            <div className="relative">
              ...
              <Loader2 className="relative w-16 h-16 animate-spin text-red-600 mx-auto mb-4" />
            </div>
            <p className="text-lg font-medium text-gray-600 dark:text-gray-400 animate-pulse">Loading expense data...</p>
          </div>
        </main>
      </div>
    );
      ...
      <main className="flex-1 lg:ml-72 pt-16 lg:pt-0 p-4 sm:p-6 lg:p-8 animate-in fade-in duration-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 animate-in slide-in-from-top duration-500">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-red-600 via-red-700 to-red-600 dark:from-red-400 dark:via-red-500 dark:to-red-400 bg-clip-text text-transparent mb-2">
                Expense Tracker
              </h1>
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl active:scale-95 touch-manipulation"
            >
              <Minus size={20} />
              Add Expense
            </button>
          ...
          {/* Total Expenses Card */}
          <div className="relative overflow-hidden bg-gradient-to-br from-red-500 via-red-600 to-red-700 rounded-2xl p-8 shadow-2xl mb-8 hover:shadow-3xl transition-all duration-300 hover:scale-[1.01] animate-in slide-in-from-bottom duration-500 delay-100">
            ...
            <div className="relative">
              ...
              <p className="text-white text-4xl sm:text-5xl font-bold truncate mb-2" title={formatAmount(totalExpenses, false)}>
                {formatAmount(totalExpenses, true)}
              </p>
              <p className="text-red-100 text-sm font-medium">
                📊 {transactions.length} expense {transactions.length === 1 ? 'entry' : 'entries'}
              </p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all touch-manipulation"
                      required
                      disabled={submitting}
                    >
            ...
            {transactions.length === 0 ? (
              <div className="p-12 text-center">
                <div className="w-20 h-20 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Minus size={32} className="text-red-600 dark:text-red-400" />
                </div>
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {transactions.map((transaction, index) => (
                  <div 
                    key={transaction.id} 
                    className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-gradient-to-r hover:from-red-50 hover:to-transparent dark:hover:from-red-900/10 dark:hover:to-transparent transition-all duration-200 group"
                    style={{ animationDelay: `${index * 50}ms` }}
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        <span className="px-3 py-1.5 bg-gradient-to-r from-red-100 to-red-200 dark:from-red-900/30 dark:to-red-800/30 text-red-700 dark:text-red-300 rounded-full text-sm font-semibold shadow-sm">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-4">
                      <span className="text-xl sm:text-2xl font-bold text-red-600 dark:text-red-400 truncate" title={formatAmount(transaction.amount, false)}>
